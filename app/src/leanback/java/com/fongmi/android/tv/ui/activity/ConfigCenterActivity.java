...
public class ConfigCenterActivity extends BaseActivity implements ConfigAdapter.OnClickListener, ConfigListener {
    ...
    private ActivityKeepBinding binding;
    ...
    protected ViewBinding getBinding() {
        return binding = ActivityKeepBinding.inflate(getLayoutInflater());
    }

    @Override
    protected void initView(Bundle savedInstanceState) {
        type = getIntent().getIntExtra("type", 0);
        setTitle(type == 0 ? R.string.config_center_vod : type == 1 ? R.string.config_center_live : R.string.config_center_wall);
